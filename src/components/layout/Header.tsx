...
export const Header: React.FC = () => {
    ...
    const getNotificationIcon = (type: string) => {
        switch (type) {
            ...
            case 'PartRequest':
                return 'bi-cart-check text-warning';

            case 'ALERT':
                return 'bi-exclamation-triangle text-danger';

            case 'PASSWORD_RESET_REQUIRED':
                return 'bi-shield-lock text-primary';
                                    ...
                                    {notifications.length === 0 ? (
                                        ...
                                        notifications.map(n => (
                                            ...
                                            <Dropdown.Item
                                                ...
                                                className={`p-3 border-bottom ${n.isRead
                                            ...
                                            >
                                                <div className="d-flex gap-2 align-items-start">
                                                    ...
                                                    <i
                                                        className={`bi ${getNotificationIcon(n.type)} mt-1 flex-shrink-0`}
                                                    ></i>

                                                    <div style={{ minWidth: 0 }}>

                                                        <p
                                                            className={`mb-1 ${!n.isRead
                                                                    ? 'fw-semibold'
                                                                    : ''
                                                                }`}
                                                            style={{
