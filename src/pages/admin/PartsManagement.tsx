        ...
        >
                            ...
                            <tbody>
                                {filteredParts.map((p, index) => (
                                    ...
                                    >
                                        ...
                                        <td className="p-3 align-middle fw-semibold text-light">
                                            {p.partName}
                                        </td>
                                        ...
                                        <td
                                            className="p-3 align-middle text-secondary"
                                            style={{
                                                maxWidth: '180px',
                                                overflow: 'hidden',
                                        ...
                                        <td className="p-3 align-middle text-info fw-medium">
                                            {p.stockQuantity}
                                        </td>
            ...
            >
                ...
                >
                    <Modal.Title>
                        <i
                            className={`bi ${editingPart ? 'bi-pencil-square' : 'bi-plus-circle'
                                } me-2`}
                        ></i>
                    ...
                    <Form>
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Text className="text-secondary">
                                Low Stock alert shows when stock ≤ this number
                            </Form.Text>
                        </Form.Group>
                    </Form>
                </Modal.Body>
                ...
                <Modal.Body className="bg-dark text-light">
                    <div className="d-flex align-items-start gap-3">
                        ...
                        <div>
                            ...
                            <strong>{deletingPart?.partName}</strong>?
