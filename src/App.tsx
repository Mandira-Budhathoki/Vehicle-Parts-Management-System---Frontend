...
import { CustomerRegistration as StaffRegCust } from './pages/staff/CustomerRegistration';
...
import { History as CustomerHistory } from './pages/customer/History';         // Feature 14
                            ...
                            <Routes>
                                ...
                                <Route element={<ProtectedRoute><AppLayout /></ProtectedRoute>}>
                                    ...
                                    <Route path="/admin">
                                        ...
                                        <Route path="reviews" element={<ProtectedRoute allowedRoles={['admin']}><StaffReviews /></ProtectedRoute>} />
                                    </Route>
                                    ...
                                    <Route path="/staff">
                                        ...
                                        <Route path="register-customer" element={<ProtectedRoute allowedRoles={['staff']}><StaffRegCust /></ProtectedRoute>} />
                                        ...
                                        {/* Feature 13 — new */}
                                        <Route path="appointments" element={<ProtectedRoute allowedRoles={['staff']}><StaffAppointments /></ProtectedRoute>} />
                                        <Route path="part-requests" element={<ProtectedRoute allowedRoles={['staff']}><StaffPartRequests /></ProtectedRoute>} />
                                        <Route path="reviews" element={<ProtectedRoute allowedRoles={['staff']}><StaffReviews /></ProtectedRoute>} />
                                    </Route>
